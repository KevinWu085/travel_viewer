...
function updateUIStrings() {
    ...
    // Safety checks and text updates
...
// --- Logic for Adding & Removing Events ---
...
/**
 * Generates event card HTML.
 * Now accepts dayIdx and evtIdx to enable deletion.
 */
function generateEventCard(e, dayIdx, evtIdx) {
    ...
    return `
        <div class="bg-white p-5 rounded-3xl border border-gray-300 shadow-sm flex space-x-4 items-start active:scale-95 transition-transform slide-up relative group">
            ...
            <div class="flex-grow pr-6"> <div class="flex justify-between items-center mb-1">
...
function renderCategory(category) {
    ...
    // Loop with indices to support deletion in category view
